    ...
    return (
        <>
            <div className="flex justify-center py-20 overflow-hidden">
                <h1 className="text-black text-5xl md:text-7xl font-bold text-center flex gap-4">
                    <motion.span
            ...
            <div className="max-w-4xl mx-auto px-6 pb-20">
                <p className="text-gray-500 text-xl leading-relaxed text-left mb-16 font-normal">
                    Welcome to Movingshadow.com, owned and operated by Moving Shadow. By using this website, you accept and agree to comply with these Terms and Conditions. Please read the following terms carefully.</p>
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">1. Intellectual Property:</h2>

                    <p className="text-gray-800 text-base leading-relaxed">The content, design, and intellectual property of this website are owned by Moving Shadow. Reproduction, distribution, or any other use of the materials on this website is prohibited without the express written consent of Moving Shadow.
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">2. Accuracy of Information:</h2>

                    <p className="text-gray-800 text-base leading-relaxed">While we strive to provide accurate and up-to-date information on this website, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability of the information, products, services, or related graphics.
                ...
                {/* 3 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">3. Product Availability:</h2>
                ...
                {/* 4 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">4. External Links:</h2>
                ...
                {/* 5 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">5. User Responsibilities:</h2>
                ...
                {/* 6 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">6. Order Acceptance:</h2>
                ...
                {/* 7 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">7. Pricing and Payment:</h2>
                ...
                {/* 8 */}
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">8. Shipping:</h2>
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">9. Returns and Refunds:</h2>
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">10. User Accounts:</h2>
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">11. Changes to Terms and Conditions:</h2>
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">12. Governing Law:</h2>
                ...
                <div className="flex flex-col gap-4 text-left mt-8">
                    <h2 className="text-3xl font-bold text-[#111]">13. Contacting Us:</h2>
