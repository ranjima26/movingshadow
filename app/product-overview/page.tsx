...
function classNames(...classes: (string | boolean | undefined | null | any)[]) {
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <form className="mt-10">
                            ...
                            <div className="mt-10 flex flex-col gap-4">
                                {/* Add to Bag: Minimalist White/Black style */}
                                <button
                                    type="button"
                                ...
                                <button
                                    type="button"
                                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-green-700 px-8 py-3 text-base font-medium text-white hover:bg-green-800 focus:outline-none"
                                >
                                    Buy Now
                                </button>
                            </div>
